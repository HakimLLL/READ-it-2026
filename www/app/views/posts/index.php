                    ...
                    <div class="text p-4 float-right d-block">
                        <div class="topper d-flex align-items-center">
                            <div class="one py-2 pl-3 pr-1 align-self-stretch">
                                <span class="day">
                                    <?php echo \Core\Helpers\dateFormator($post['created_at'], 'd'); ?>
                                </span>
                            </div>
                            <div class="two pl-0 pr-3 py-2 align-self-stretch">
                                <span class="yr">
                                    <?php echo \Core\Helpers\dateFormator($post['created_at'], 'Y'); ?>
                                </span>
                                <span class="mos">
                                    <?php echo \Core\Helpers\dateFormator($post['created_at'], 'M'); ?>
                                </span>
                            </div>
                        </div>
